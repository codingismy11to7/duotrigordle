...
import { showPopup, updateSettings, useAppDispatch, useSelector } from "../store";
      ...
      <div className="popup">
        <div className="group">
          <input
            ...
            onChange={e => dispatch(updateSettings({ colorBlindMode: e.target.checked }))}
          />
        ...
        <div className="group">
          <input
            ...
            id="show-timer"
            checked={showTimer}
            onChange={e => dispatch(updateSettings({ showTimer: e.target.checked }))}
          />
        ...
        <div className="group">
          <input
            ...
            id="wide-mode"
            checked={wideMode}
            onChange={e => dispatch(updateSettings({ wideMode: e.target.checked }))}
          />
        ...
        <div className="group">
          <input
            ...
            onChange={e => dispatch(updateSettings({ hideCompletedBoards: e.target.checked }))}
          />
        ...
        <div className={cn("group", "animate-hiding", !hideCompletedBoards && "active")}>
          <input
            ...
            onChange={e => dispatch(updateSettings({ animateHiding: e.target.checked }))}
        ...
        <div className="group">
          <input
            ...
            onChange={e => dispatch(updateSettings({ hideKeyboard: e.target.checked }))}
          />
        ...
        <div className="group">
          <input
            ...
            onChange={e => dispatch(updateSettings({ useFloatingInput: e.target.checked }))}
          />
        ...
        <div className="group">
          <input
            ...
            onChange={e => dispatch(updateSettings({ hideEmptyRows: e.target.checked }))}
          />
