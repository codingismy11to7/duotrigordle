...
import { addDebugHooks, useAppDispatch, useSelector } from "../store";
...
export default function App() {
  ...
  const gameWin = useMemo(() => getAllWordsGuessed(targets, guesses), [targets, guesses]);
  ...
  if (window.top !== window) {
    return (
      <p>
        ...
        (if you are seeing this message, the website you&apos;re playing on probably stole this game and/or is making ad
        revenue)
      </p>
    );
  }
  ...
  return (
    <div
      className={cn(
        ...
        wideMode && "wide",
        hideCompletedBoards && !(gameWin || gameLose) && "hide-completed-boards",
